...
// ✅ Total Incidents Monitored (daily_logs)
...
// ✅ List of Months (for correct order)
        ...
        <form method="POST" action="update_troubleshooting.php">
            <table class="min-w-full bg-white border border-gray-300">
                <thead>
                    ...
                    <tr>
                        <th colspan="14" class="text-center text-lg py-2"></th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-100">
                        ...
                        <?php endforeach; ?>
                        <td class="border px-4 py-2 text-center font-bold"><?php echo $total_troubleshooting; ?></td>
                    </tr>
